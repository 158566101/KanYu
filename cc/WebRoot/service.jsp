...
<body>
    ...
    <div class="tools" >
	     <ul class="seachform">	    
		    ...
		    <li><label>&nbsp;</label><input name=""  type="button" class="scbtn" id="query1" value="查询"/></li>	
	    </ul>
    ...
    <div class="tip">
      ...
      <div class="tipinfo">
        <span><img src="images/t03.png" style="height: 100%;width:100%;"/></span>
        <div class="tipright">
        <p>是否确认对信息的删除 ？</p>
     ...
     <div class="tip1" style="z-index: 9;">
      ...
      <div class="tipinfo1" style="overflow-y:auto;">
        ...
        <div class="tipbtn1">
        <input name="" type="button"  class="sure1" value="修改订单" onclick="updateServiceAdd()" />&nbsp;
	...
	<script type="text/javascript" src="js/js/serviceOrder.js"></script>
</body>
</html>
