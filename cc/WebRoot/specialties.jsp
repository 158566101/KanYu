...
</script><script type="text/javascript" src="jiaoben/jedate/jedate.js"></script></head>
...
<body>
    ...
    <div class="tip1" style="z-index: 9;">
      ...
      <div class="tipinfo1" style="overflow-y:auto;">
        ...
        <div class="tipbtn1">
        <input name="" type="button"  class="sure1" value="修改订单" onclick="updateSpecialtiesadd()" />&nbsp;
        <input name="" type="button"  class="cancel" value="取消修改" onclick="tanchu()" />
        </div>
    
    </div>
    <script type="text/javascript" src="js/js/SpecialtiesOrder.js">
    <script type="text/javascript">
